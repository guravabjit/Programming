...
mat4 modelMetrices[32];
int giModelMetricesIndex = 0;
...
void pushModel(mat4 metrix)
{
	if (giModelMetricesIndex > 32)
	{
		return;
	}
	modelMetrices[giModelMetricesIndex];
	giModelMetricesIndex++;
	return;
}
...
mat4 popModel()
{
	...
	if (giModelMetricesIndex < 0)
	{
		return temp;
	}
	
	temp = modelMetrices[giModelMetricesIndex];
	giModelMetricesIndex--;
	return temp;
}
