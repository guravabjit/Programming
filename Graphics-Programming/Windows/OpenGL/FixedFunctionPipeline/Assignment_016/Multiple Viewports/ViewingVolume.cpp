...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR szCmdLine, int iCmdShow)
{
	...
	bool bIsDone = false;
	int iRet = 0;
	TCHAR szAppName[] = TEXT("Multilpe VP/VV");
	WNDCLASSEX wndclass;
	HWND hWnd;
	MSG msg;
	...
	hWnd = CreateWindowEx(WS_EX_APPWINDOW,
		szAppName,
		TEXT("Multiple viewports/viewing volume"),
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_SIZE:
		...
		giHeigth = HIWORD(lParam);
		resize(giWidth, giHeigth);
		break;
	...
	case WM_KEYDOWN:
		...
		case '8':
			giVPx = 0;
			giVPy = 0;
			resize(giWidth, giHeigth / 2);
			break;

		case '9':
			giVPx = giWidth / 4;
			giVPy = giWidth / 4;
			resize(giWidth / 4, giHeigth / 4);
			break;
		}
		break;
	case WM_DESTROY:
