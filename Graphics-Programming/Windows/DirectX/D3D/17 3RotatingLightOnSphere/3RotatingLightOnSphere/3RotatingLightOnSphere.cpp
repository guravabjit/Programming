...
float lightDiffuseGreen[] = { 0.0f, 1.0f, 0.0f, 1.0f };
float lightSpecularGreen[] = { 0.0f, 1.0f, 0.0f, 1.0f };
...
void display()
{
	...
	if (gbLighting == true)
	{
		...
		lightPositionRed[1] = sinf(fAngleRot) * 100.0f;
		lightPositionRed[2] = cosf(fAngleRot) * 100.0f;
		...
		lightPositionGreen[0] = sinf(fAngleRot) * 100.0f;
		lightPositionGreen[1] = 0.0f;
		lightPositionGreen[2] = cosf(fAngleRot) * 100.0f + 3.0f;
		...
		lightPositionBlue[0] = cosf(fAngleRot) * 100.0f;
		lightPositionBlue[1] = sinf(fAngleRot) * 100.0f;
