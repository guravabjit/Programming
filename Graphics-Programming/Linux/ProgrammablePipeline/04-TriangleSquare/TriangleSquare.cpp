...
typedef GLXContext(*glxContextCreateContextAttribARBProc)(Display*, GLXFBConfig, GLXContext, Bool, const int*);
glxContextCreateContextAttribARBProc glxContextCreateContextAttribARB = NULL;
...
*/
	...
	XStoreName(gpDisplay, gWindow, "Triangle Square");
